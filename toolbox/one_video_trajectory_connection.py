...
def connect_drivingline(vehicle_data, region):
    ...
    speed_time = 5  # seconds 用于计算速度的历史时间区间
    max_expand_time = 40  # seconds 最大的延伸时长
...
if __name__ == '__main__':
    ...
    tppkl_path = '/data3/liyitong/HuRong_process/A2/20220616_0725_A2_F2_372_1_Num_4/tp_result_20220616_0725_A2_F2_372_1.tppkl'
    new_tppkl_path = '/data3/liyitong/HuRong_process/A2/20220616_0725_A2_F2_372_1_Num_4/tp_result_20220616_0725_A2_F2_372_1_new_1.tppkl'
    #region = [2900,3094,2914,3050,'linear']
    #region = [3064 , 3141 , 3084 , 3129 , 'linear']
    #region = [3164 , 3241 , 3184 , 3229 , 'linear']
    region = [410 , 500 , 400 , 490 , 'linear']

    region = [230 , 400 , 250 , 380 , 'linear']
    ...
    for veh_id,veh_data in vehicles_data.items():
        ...
        if drivingline[0] > drivingline[-1]:
            ...
            drivingline_mainroad['mainroad'] = drivingline
